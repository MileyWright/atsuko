            ...
            <div className='right'>
                <div className='top_right'>
                    ...
                    <Radio.Group className='radio_button' buttonStyle="solid" checked={false} onChange={handleChange}>
                        <Radio.Button className='phone_button'value="IPhone X">IPhone X</Radio.Button>
                        <Radio.Button className='phone_button' value="IPhone XS">IPhone XS</Radio.Button>
                        <Radio.Button className='phone_button' value="IPhone 11">IPhone 11</Radio.Button>
                        <Radio.Button className='phone_button' value="IPhone 11 Pro">IPhone 11 Pro</Radio.Button>
                        <Radio.Button className='phone_button' value="IPhone 11 Pro Max">IPhone 11 Pro Max</Radio.Button>
                        <Radio.Button className='phone_button' value="IPhone 12">IPhone 12</Radio.Button>
                        <Radio.Button className='phone_button' value="IPhone 12 Pro">IPhone 12 Pro</Radio.Button>
                        <Radio.Button className='phone_button' value="IPhone 12 Pro Max">IPhone 12 Pro Max</Radio.Button>
                    </Radio.Group>
                </div>
